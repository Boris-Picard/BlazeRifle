                            ...
                            <div class="col-12">
                                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Preview Des jeux PS5</li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="col-md-8 col-12 py-3">
                                <h2 class="h2 text-uppercase fw-bold">Tous les articles PS5</h2>
                            </div>
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-end h-100 p-0">
                                            ...
                                            <div class="card-text mb-3">
                                                <small>Il y a 20 heures
                                                    ...
                                                    <span class="badge rounded-pill text-uppercase border bg-transparent text-light fw-semibold">PS5</span>
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-img-overlay">
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-end h-100 p-0">
                                            <a href="#" class="lh-1 card-text fw-bold stretched-link aCard text-wrap text-decoration-none text-light mb-1">
                                                Je ne m'attendais pas à trouver un PS5 portable gamer
                                            </a>
                                            <div class="card-text mb-3">
                                                <small>Il y a 20 heures
                                                    <span class="badge rounded-pill text-uppercase mb-1 mx-1 border fw-semibold"><i class="bi bi-chat-right-dots mx-1 align-middle"></i>5</span>
                                    ...
                                    <div class="card-body p-0 mt-1">
                                        ...
                                        <div class="card-text mb-3">
                                            <small class="text-muted">25 déc, 18:05
                                                ...
                                                <span class="badge rounded-pill text-uppercase border bg-transparent text-dark fw-semibold">PS5</span>
                                            </small>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="card-body w-100 cardGuideRight p-0 mx-2 d-flex flex-column">
                                                ...
                                                <p class="card-text">
                                                    <small class="text-muted">Il y a 5 heures
                                                        ...
                                                        <span class="badge rounded-pill text-uppercase border bg-dark text-light fw-semibold">PS5</span>
                                                    </small>
                                                </p>
                                            </div>
                                        </div>
