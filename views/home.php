<main>
    ...
    <section class="sectionContainer">
        <div class="container">
            <div class="row g-5">
                <div class="col-12">
                    <h1 class="text-dark text-uppercase my-4 articleTitle fw-bold">Les News</h1>
                </div>
                <div class="col-12">
                    <div class="row row-cols-3">
                        <div class="col-12 col-md-6 p-0"><img src="/public/assets/img/gamingherobg.jpg" alt="" class="img-fluid "></div>
                        <div class="col-12 col-md-6 p-0"><img src="/public/assets/img/gamingherobg.jpg" alt="" class="img-fluid "></div>
                        <div class="col-12 col-sm-4 p-0"><img src="/public/assets/img/gamingherobg.jpg" alt="" class="img-fluid "></div>
                        <div class="col-12 col-sm-4 p-0"><img src="/public/assets/img/gamingherobg.jpg" alt="" class="img-fluid "></div>
                        <div class="col-12 col-sm-4 p-0"><img src="/public/assets/img/gamingherobg.jpg" alt="" class="img-fluid "></div>
                    </div>
                </div>
