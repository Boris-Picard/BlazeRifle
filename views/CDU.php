<main>
    <section class="contactContainer p-5">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1>Conditions d'utilisation du formulaire de contact</h1>
                    <h2 class="mt-5">
                        Bienvenue sur <span class="nameLogoNav">BlazeRifle !</span>
                    </h2>
                    <p class="mt-5">
                    ...
                    <p class="mt-3">
                        Toute modification sera effective dès sa publication sur notre site web. Il est de votre responsabilité de consulter régulièrement cette page pour prendre connaissance des éventuelles mises à jour.
                    </p>
                    <p class="mt-3">
                        En utilisant notre formulaire de contact, vous acceptez les conditions énoncées ci-dessus.
                    </p>
                    <p class="mt-3">
                        Si vous avez des questions ou des préoccupations concernant ces conditions d'utilisation, veuillez nous contacter à l'adresse fournie sur notre site web.
                    </p>
                    <p class="mt-3">
                        Merci d'utiliser le formulaire de contact de BlazeRifle !
                    </p>
                </div>
            </div>
        </div>
