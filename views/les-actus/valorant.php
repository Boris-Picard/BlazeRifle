                ...
                <div class="col-md-8 col-12">
                    <div class="row">
                        <div class="col-12 mt-3 justify-content-center d-flex flex-column align-items-center">
                            <h2 class="h2 text-uppercase fw-bold text-center">valorant</h2>
                            <p class="text-center mt-2">Valorant" est un jeu de tir à la première personne tactique, développé et publié par Riot Games. 
                                Sorti en 2020, il combine des éléments de jeux de tir classiques avec des compétences uniques de personnages, appelés "Agents". 
                                Chaque agent possède des capacités spéciales qui influencent la stratégie et le style de jeu. 
                                Le gameplay principal tourne autour de matchs 5 contre 5, où une équipe doit poser une bombe ("Spike") et l'autre doit la désamorcer, 
                                avec un accent sur le tir précis et la tactique d'équipe. Valorant est apprécié pour son mélange d'action stratégique, son design artistique distinct, 
                                et son engagement envers l'intégrité compétitive, notamment grâce à un système anti-triche robuste.
                            </p>
                        </div>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12 p-0 py-3">
                        <div class="card mb-4 border-0 bg-transparent cardsActus shadow-lg rounded-4">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="/public/assets/img/valorant.jpg" class="img-fluid object-fit-cover cardsActus rounded-start rounded-3" alt="valorant">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body px-3 d-flex flex-column justify-content-end">
                                        <div>
                                            <span class="badge rounded-pill text-bg-danger p-2 mb-2 text-uppercase">valorant</span>
                                        </div>
                        ...
                        <div class="col-12 widthColRightActu shadow-lg rounded-4">
                            <div class="row">
                                <div class="col-12 d-flex flex-row text-center align-items-center p-3">
                                    ...
                                    <h5 class="text-uppercase fw-bold"><span class="text-danger">les guides :</span> valorant</h5>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="card mt-3 p-0 border-0 bg-transparent">
                                        <div class="card-img-top ratio ratio-16x9">
                                            <img src="/public/assets/img/valorant.jpg" class="object-fit-cover rounded-3" alt="valorant" />
                                        </div>
                                    ...
                                    <div class="card cardActuGuideRight bg-transparent border-0 overflow-hidden mt-2">
                                        <div class="row g-0 cardActuGuideRight">
                                            <div class="col-auto">
                                                <img src="/public/assets/img/valorant.jpg" alt="valorant" class="imgActuGuideRight object-fit-cover rounded-3" />
                                            </div>
                        ...
                        <div class="col-12 widthColRightVideo shadow-lg rounded-4">
                            <div class="row">
                                <div class="col-12 d-flex flex-row text-center align-items-center p-3">
                                    ...
                                    <h5 class="text-uppercase fw-bold"><span class="text-warning">les vidéos :</span> valorant</h5>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
