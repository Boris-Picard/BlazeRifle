                ...
                <div class="col-md-8 col-12">
                    <div class="row">
                        <div class="col-12 mt-3 justify-content-center d-flex flex-column align-items-center">
                            <h2 class="h2 text-uppercase fw-bold text-center">apex legends</h2>
                            <p class="text-center mt-2">Apex Legends" est un jeu de tir à la première personne de type battle royale, développé par Respawn Entertainment.
                                Dans ce jeu, les joueurs sont regroupés en équipes de trois et parachutés sur une île où ils doivent se battre contre d'autres équipes pour être les derniers survivants.
                                Le jeu se distingue par son système de "Légendes", des personnages uniques avec des compétences spéciales, offrant une variété de styles de jeu tactiques.
                                "Apex Legends" est reconnu pour son gameplay rapide, son système de communication innovant et ses mécaniques de combat fluides,
                                combinant tir et mouvement dans un univers futuriste et compétitif.
                            </p>
                        </div>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12 p-0 py-3">
                        <div class="card mb-4 border-0 bg-transparent cardsActus shadow-lg rounded-4">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="/public/assets/img/apex.jpg" class="img-fluid object-fit-cover cardsActus rounded-start rounded-3" alt="apex legends">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body px-3 d-flex flex-column justify-content-end">
                                        <div>
                                            <span class="badge rounded-pill text-bg-danger p-2 mb-2 text-uppercase">apex legends</span>
                                        </div>
                        ...
                        <div class="col-12 widthColRightActu shadow-lg rounded-4">
                            <div class="row">
                                <div class="col-12 d-flex flex-row text-center align-items-center p-3">
                                    ...
                                    <h5 class="text-uppercase fw-bold"><span class="text-danger">les guides :</span> apex legends</h5>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="card mt-3 p-0 border-0 bg-transparent">
                                        <div class="card-img-top ratio ratio-16x9">
                                            <img src="/public/assets/img/apex.jpg" class="object-fit-cover rounded-3" alt="apex legends" />
                                        </div>
                                    ...
                                    <div class="card cardActuGuideRight bg-transparent border-0 overflow-hidden mt-2">
                                        <div class="row g-0 cardActuGuideRight">
                                            <div class="col-auto">
                                                <img src="/public/assets/img/apex.jpg" alt="apex legends" class="imgActuGuideRight object-fit-cover rounded-3" />
                                            </div>
                        ...
                        <div class="col-12 widthColRightVideo shadow-lg rounded-4">
                            <div class="row">
                                <div class="col-12 d-flex flex-row text-center align-items-center p-3">
                                    ...
                                    <h5 class="text-uppercase fw-bold"><span class="text-warning">les vidéos :</span> apex legends</h5>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
