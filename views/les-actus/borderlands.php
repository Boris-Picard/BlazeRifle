                ...
                <div class="col-md-8 col-12">
                    <div class="row">
                        <div class="col-12 mt-3 justify-content-center d-flex flex-column align-items-center">
                            <h2 class="h2 text-uppercase fw-bold text-center">borderlands 3</h2>
                            <p class="text-center mt-2">Borderlands 3", sorti en 2019, est un jeu de tir à la première personne avec des éléments de RPG, 
                                développé par Gearbox Software. Il s'inscrit dans la série "Borderlands", connue pour son style graphique unique en cel-shading 
                                et son humour décalé. Dans "Borderlands 3", les joueurs explorent de nouveaux mondes au-delà de Pandora, 
                                chacun avec ses propres environnements et ennemis. Le jeu propose quatre nouveaux "Chasseurs de l'Arche" avec des 
                                compétences uniques, et un système de loot amélioré offrant une grande variété d'armes et d'équipements. 
                                La campagne principale suit la lutte contre les Jumeaux Calypso, leaders d'un culte galactique. 
                                "Borderlands 3" a été salué pour son gameplay addictif, ses graphismes colorés, et son mode coopératif, 
                                bien qu'il ait reçu des critiques pour certains aspects de son scénario et son humour.
                            </p>
                        </div>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12 p-0 py-3">
                        <div class="card mb-4 border-0 bg-transparent cardsActus shadow-lg rounded-4">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="/public/assets/img/borderlands3.jpg" class="img-fluid object-fit-cover cardsActus rounded-start rounded-3" alt="borderlands 3">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body px-3 d-flex flex-column justify-content-end">
                                        <div>
                                            <span class="badge rounded-pill text-bg-danger p-2 mb-2 text-uppercase">borderlands 3</span>
                                        </div>
                        ...
                        <div class="col-12 widthColRightActu shadow-lg rounded-4">
                            <div class="row">
                                <div class="col-12 d-flex flex-row text-center align-items-center p-3">
                                    ...
                                    <h5 class="text-uppercase fw-bold"><span class="text-danger">les guides :</span> borderlands 3</h5>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="card mt-3 p-0 border-0 bg-transparent">
                                        <div class="card-img-top ratio ratio-16x9">
                                            <img src="/public/assets/img/borderlands3.jpg" class="object-fit-cover rounded-3" alt="borderlands 3" />
                                        </div>
                                    ...
                                    <div class="card cardActuGuideRight bg-transparent border-0 overflow-hidden mt-2">
                                        <div class="row g-0 cardActuGuideRight">
                                            <div class="col-auto">
                                                <img src="/public/assets/img/borderlands3.jpg" alt="borderlands 3" class="imgActuGuideRight object-fit-cover rounded-3" />
                                            </div>
                        ...
                        <div class="col-12 widthColRightVideo shadow-lg rounded-4">
                            <div class="row">
                                <div class="col-12 d-flex flex-row text-center align-items-center p-3">
                                    ...
                                    <h5 class="text-uppercase fw-bold"><span class="text-warning">les vidéos :</span> borderlands 3</h5>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
