                ...
                <div class="col-md-8 col-12">
                    <div class="row">
                        <div class="col-12 mt-3 justify-content-center d-flex flex-column align-items-center">
                            <h2 class="h2 text-uppercase fw-bold text-center">call of duty : warzone</h2>
                            <p class="text-center mt-2">Call of Duty: Warzone" est un jeu de tir à la première personne gratuit dans le style battle royale,
                                développé par Infinity Ward et Raven Software. Sorti en 2020, il fait partie de la franchise "Call of Duty".
                                Dans Warzone, les joueurs sont largués sur une vaste carte, Verdansk, où ils doivent se battre pour être le dernier survivant,
                                soit en solo, soit en équipe. Le jeu intègre des éléments uniques comme des contrats à accomplir pour des récompenses, un système
                                de réanimation permettant aux joueurs éliminés de revenir au combat, et une économie en jeu pour acheter des équipements.
                                Warzone est connu pour son intégration avec d'autres jeux de la série, son gameplay dynamique, et ses mises à jour régulières
                                ajoutant du contenu et des événements.
                            </p>
                        </div>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12 p-0 py-3">
                        <div class="card mb-4 border-0 bg-transparent cardsActus shadow-lg rounded-4">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="/public/assets/img/MWII-SEASON-01-ROADMAP-004.jpg" class="img-fluid object-fit-cover cardsActus rounded-start rounded-3" alt="call of duty : warzone">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body px-3 d-flex flex-column justify-content-end">
                                        <div>
                                            <span class="badge rounded-pill text-bg-danger p-2 mb-2 text-uppercase">call of duty : warzone</span>
                                        </div>
                        ...
                        <div class="col-12 widthColRightActu shadow-lg rounded-4">
                            <div class="row">
                                <div class="col-12 d-flex flex-row text-center align-items-center p-3">
                                    ...
                                    <h5 class="text-uppercase fw-bold"><span class="text-danger">les guides :</span> call of duty : warzone</h5>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="card mt-3 p-0 border-0 bg-transparent">
                                        <div class="card-img-top ratio ratio-16x9">
                                            <img src="/public/assets/img/MWII-SEASON-01-ROADMAP-004.jpg" class="object-fit-cover rounded-3" alt="call of duty : warzone" />
                                        </div>
                                    ...
                                    <div class="card cardActuGuideRight bg-transparent border-0 overflow-hidden mt-2">
                                        <div class="row g-0 cardActuGuideRight">
                                            <div class="col-auto">
                                                <img src="/public/assets/img/MWII-SEASON-01-ROADMAP-004.jpg" alt="call of duty : warzone" class="imgActuGuideRight object-fit-cover rounded-3" />
                                            </div>
                        ...
                        <div class="col-12 widthColRightVideo shadow-lg rounded-4">
                            <div class="row">
                                <div class="col-12 d-flex flex-row text-center align-items-center p-3">
                                    ...
                                    <h5 class="text-uppercase fw-bold"><span class="text-warning">les vidéos :</span> call of duty : warzone</h5>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
