                ...
                <div class="col-md-8 col-12">
                    <div class="row">
                        <div class="col-12 mt-3 justify-content-center d-flex flex-column align-items-center">
                            <h2 class="h2 text-uppercase fw-bold text-center">overwatch 2</h2>
                            <p class="text-center mt-2">Overwatch 2" est un jeu de tir à la première personne axé sur le travail d'équipe, 
                                développé et publié par Blizzard Entertainment. Comme suite du premier "Overwatch", 
                                le jeu se concentre sur des combats 5 contre 5 entre des héros aux capacités uniques, promouvant une forte synergie d'équipe et des stratégies variées. 
                                Overwatch 2 introduit de nouveaux héros, cartes, et modes de jeu, ainsi qu'une composante de missions en coopération contre l'IA. 
                                Le jeu se distingue par son style graphique coloré et vibrant, ainsi que par son univers narratif riche, 
                                continuant les histoires des personnages bien-aimés du premier opus. Overwatch 2 vise à approfondir 
                                l'expérience de jeu avec des mises à jour régulières et du contenu collaboratif.
                            </p>
                        </div>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12 p-0 py-3">
                        <div class="card mb-4 border-0 bg-transparent cardsActus shadow-lg rounded-4">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="/public/assets/img/overwatch-2-key-art-4k-ah-2048x1152-1.jpg.webp" class="img-fluid object-fit-cover cardsActus rounded-start rounded-3" alt="overwatch 2">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body px-3 d-flex flex-column justify-content-end">
                                        <div>
                                            <span class="badge rounded-pill text-bg-danger p-2 mb-2 text-uppercase">overwatch 2</span>
                                        </div>
                        ...
                        <div class="col-12 widthColRightActu shadow-lg rounded-4">
                            <div class="row">
                                <div class="col-12 d-flex flex-row text-center align-items-center p-3">
                                    ...
                                    <h5 class="text-uppercase fw-bold"><span class="text-danger">les guides :</span> overwatch 2</h5>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="card mt-3 p-0 border-0 bg-transparent">
                                        <div class="card-img-top ratio ratio-16x9">
                                            <img src="/public/assets/img/overwatch-2-key-art-4k-ah-2048x1152-1.jpg.webp" class="object-fit-cover rounded-3" alt="overwatch 2" />
                                        </div>
                                    ...
                                    <div class="card cardActuGuideRight bg-transparent border-0 overflow-hidden mt-2">
                                        <div class="row g-0 cardActuGuideRight">
                                            <div class="col-auto">
                                                <img src="/public/assets/img/overwatch-2-key-art-4k-ah-2048x1152-1.jpg.webp" alt="overwatch 2" class="imgActuGuideRight object-fit-cover rounded-3" />
                                            </div>
                        ...
                        <div class="col-12 widthColRightVideo shadow-lg rounded-4">
                            <div class="row">
                                <div class="col-12 d-flex flex-row text-center align-items-center p-3">
                                    ...
                                    <h5 class="text-uppercase fw-bold"><span class="text-warning">les vidéos :</span> overwatch 2</h5>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
