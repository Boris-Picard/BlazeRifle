            ...
            <section>
                <div class="row">
                    ...
                    <div class="col-md-4 col-12 mt-3">
                        <div class="row mx-4 rounded-5">
                            <div class="col-12 widthColRightActu shadow-lg rounded-5">
                                <div class="row">
                            ...
                            <!-- LES VIDEOS -->
                            <div class="mt-4"></div>
                            <div class="col-12 widthColRightVideo shadow-lg rounded-5">
                                <div class="row">
                                    <div class="col-12 d-flex flex-row text-center align-items-center p-3">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex justify-content-center mt-3 mb-4">
                                            <a href="#" class="btn btn-warning w-50 rounded-5 p-1 fw-bold text-uppercase">
                                                les vidéos
                                            </a>
                                        </div>
                                    </div>
