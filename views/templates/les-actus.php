        ...
        <div class="container">
            <section>
                <div class="row">
                    <div class="col-8">
                        <div class="row">
                            <div class="col-12 mt-3 justify-content-center d-flex flex-column align-items-center">
                                <h2 class="h2 text-uppercase fw-bold">Call of Duty: Modern Warfare 3</h2>
                        ...
                        <div class="col-12 p-0 py-3">
                            <div class="card mb-4 border-0 bg-transparent cardsActus shadow-lg rounded-5">
                                <div class="row g-0">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body px-3 d-flex flex-column justify-content-end">
                                            ...
                                            <a href="#" class="stretched-link mt-2 h5 aCard text-decoration-none card-title fw-bold">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et, magni quisquam. Earum aperiam magni et minus quisquam fuga dicta amet quaerat quod voluptatum accusantium, unde veniam. Tenetur error est quos?</a>
                                            <p class="aCard mt-2">
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body px-3 d-flex flex-column justify-content-end">
                                            ...
                                            <a href="#" class="stretched-link mt-2 h5 text-decoration-none aCard card-title fw-bold">Meilleures armes Zombie Modern Warfare 3 : lesquelles choisir pour survivre ?</a>
                                            <p class="aCard mt-2">
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body px-3 d-flex flex-column justify-content-end">
                                            ...
                                            <a href="#" class="stretched-link mt-2 h5 text-decoration-none card-title aCard fw-bold">Meilleures armes Zombie Modern Warfare 3 : lesquelles choisir pour survivre ?</a>
                                            <p class="aCard mt-2">
                                                Vous souhaitez connaître les meilleures armes pour le mode Zombie de Call of Duty : Modern Warfare 3 ?
                                                Au lieu de vous proposer une tier list qui n’aurait que très peu d..
                                            </p>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body px-3 d-flex flex-column justify-content-end">
                                            ...
                                            <a href="#" class="stretched-link mt-2 h5 text-decoration-none card-title aCardBig fw-bold">Meilleures armes Zombie Modern Warfare 3 : lesquelles choisir pour survivre ?</a>
                                            <p class="aCard mt-2">
                                                Vous souhaitez connaître les meilleures armes pour le mode Zombie de Call of Duty : Modern Warfare 3 ?
                                                Au lieu de vous proposer une tier list qui n’aurait que très peu d..
                                            </p>
                    ...
                    <!-- LES GUIDES -->
                    <div class="col-4 mt-3 shadow-lg widthColRightActu mx-4 rounded-5">
                        <div class="row">
                            <div class="col-12">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="card mt-3 p-0 border-0 bg-transparent">
                                            ...
                                            <div class="card-body p-0 mt-1">
                                                <a href="" class="card-text stretchLinkHover aCard fw-bold text-decoration-none text-dark stretched-link">Some quick example text to build on the card title and make up the...</a>
                                                <div class="card-text mb-3">
                                                    <small class="text-muted">
                                                        25 déc, 18:05
                                                    </small>
                                        ...
                                        <div class="d-flex justify-content-center mt-3 mb-4">
                                            <a href="#" class="btn btn-danger w-50 rounded-5 p-1 fw-bold text-uppercase">
                                                les guides
                                            </a>
                                        </div>
                                    </div>
