            ...
            <div class="col-12 p-0 rounded-4 shadow-lg bg-white">
                <div class="row m-0 p-0">
                    ...
                    <div class="col-12 d-flex flex-column p-0 sidebar rounded colSidebar g-5">
                        ...
                        <a href="/controllers/dashboard/videos/add-video-ctrl.php" class="py-3 <?= $listVideos ? 'active' : '' ?> nav-link navLink text-capitalize sidebarLink"><span><i class="bi bi-youtube px-3 fw-bold"></i>Les vidéos</span></a>
