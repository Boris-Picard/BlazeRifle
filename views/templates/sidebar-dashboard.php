        ...
        <div class="row">
            <div class="col-12 p-0 rounded-4 shadow-lg bg-white">
                <div class="row m-0 p-0">
                    <a class="navbar-brand nameLogoAccount" href="/controllers/home-ctrl.php"><img src="/public/assets/img/redlogo.png" class="brandLogoAccount" alt="logo"> blazerifle</a>
                    <div class="col-12 d-flex flex-column p-0 sidebar rounded colSidebar g-5">
                        ...
                        <a href="/controllers/dashboard/category/list-categories-ctrl.php" class="<?= $listCategories ? 'active' : '' ?> py-3 nav-link navLink text-capitalize sidebarLink"><span><i class="bi bi-tag px-3 fw-bold"></i>Les catégories</span></a>
                        ...
                        <a href="/controllers/dashboard/videos/list-videos-ctrl.php" class="py-3 <?= $listVideos ? 'active' : '' ?> nav-link navLink text-capitalize sidebarLink"><span><i class="bi bi-youtube px-3 fw-bold"></i>Les vidéos</span></a>
                        <a href="/controllers/dashboard/quiz/list-quiz-ctrl.php" class="py-3 <?= $listQuiz ? 'active' : '' ?> nav-link navLink text-capitalize sidebarLink"><span><i class="bi bi-patch-question px-3 fw-bold"></i>Les Quiz</span></a>
