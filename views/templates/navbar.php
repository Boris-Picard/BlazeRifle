            ...
            <div class="collapse navbar-collapse justify-content-center gap-5 fw-bold order-md-2 offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
                ...
                <div class="navbar-nav text-center offcanvas-body">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdownGames shadow-lg">
                            <div class="d-flex flex-column">
                                <li><a href="" class="dropdown-item fw-bold text-decoration-none"><img src="/public/assets/img/gta-6-news-visu.jpg" class="rounded-circle object-fit-cover roundedImgNav" alt="GTA 6">GTA 6</a></li>
                            </div>
                        </ul>
                    </li>
