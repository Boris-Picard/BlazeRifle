    ...
    <div class="container-fluid">
        <div class="row justify-content-center rowFooter">
            <div class="col-6 col-md-2 mb-3 text-center">
                <a class="navbar-brand nameLogoFooter" href="/../controllers/home-ctrl.php"><img src="/public/assets/img/redlogo.png" class="img-fluid logoFooter" alt="logoBrand">blazerifle</a>
            </div>
            <div class="col-6 col-md-2 mb-3 text-center">
            </div>
            <div class="col-6 col-md-2 mb-3 text-center">
                <p class="fw-bold text-start">Navigation principale</p>
            ...
            <div class="col-6 col-md-2 mb-3 text-center">
                <p class="fw-bold text-start">Information</p>
                <ul class="nav flex-column text-start">
