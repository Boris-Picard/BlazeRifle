                ...
                <div class="col-md-12 col-12">
                        ...
                        <div class="col-12">
                            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Les Bons Plans</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-12 mt-3 justify-content-center d-flex flex-column align-items-center">
                            <h2 class="h2 text-uppercase fw-bold text-center">Les bons plans</h2>
                    ...
                    <div class="col-12 p-0 py-3">
                        <div class="card mb-4 border-0 bg-transparent cardsActus shadow-lg rounded-4">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="/public/assets/img/steelseries-rival-3-e1637581769996-891x500.jpg" class="img-fluid object-fit-cover cardsActus rounded-start rounded-3" alt="Les bons plans">
                                </div>
                                <div class="col-md-8">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body px-3 d-flex flex-column justify-content-end">
                                        ...
                                        <a href="/controllers/tips/tips-ctrl.php" class="stretched-link mt-2 h5 text-decoration-none aCard card-title fw-bold stretchLinkHover">Meilleures armes Zombie Modern Warfare 3 : lesquelles choisir pour survivre ?</a>
                                        <p class="aCard mt-2">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body px-3 d-flex flex-column justify-content-end">
                                        ...
                                        <a href="/controllers/tips/tips-ctrl.php" class="stretched-link mt-2 h5 text-decoration-none card-title aCard fw-bold stretchLinkHover">Meilleures armes Zombie Modern Warfare 3 : lesquelles choisir pour survivre ?</a>
                                        <p class="aCard mt-2">
                                            Vous souhaitez connaître les meilleures armes pour le mode Zombie de Call of Duty : Modern Warfare 3 ?
                                            Au lieu de vous proposer une tier list qui n’aurait que très peu d..
                                        </p>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body px-3 d-flex flex-column justify-content-end">
                                        ...
                                        <a href="/controllers/tips/tips-ctrl.php" class="stretched-link mt-2 h5 text-decoration-none card-title aCardBig fw-bold stretchLinkHover">Meilleures armes Zombie Modern Warfare 3 : lesquelles choisir pour survivre ?</a>
                                        <p class="aCard mt-2">
                                            Vous souhaitez connaître les meilleures armes pour le mode Zombie de Call of Duty : Modern Warfare 3 ?
                                            Au lieu de vous proposer une tier list qui n’aurait que très peu d..
                                        </p>
