                        ...
                        <form action="#" method="POST" class="shadow-lg p-5 rounded-4" novalidate enctype="multipart/form-data">
                            <div class="row">
                                <div class="mb-3 col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" pattern="<?= REGEX_NAME ?>" value="<?= $name ?? '' ?>" aria-describedby="name" placeholder="Ex : Valorant" minlength="2" maxlength="150" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="mb-3 col-md-12">
