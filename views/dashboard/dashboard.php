                ...
                <div class="col-12 p-0 rounded-4 shadow-lg bg-white">
                    <div class="row m-0 p-0">
                        ...
                        <div class="col-12 d-flex flex-column p-0 sidebar rounded colSidebar g-5">
                            <a href="" class="py-3 nav-link navLink active sidebarLink"><span><i class="bi bi-house px-3 fw-bold"></i> Dashboard</span></a>
                            <a href="" class="py-3 nav-link navLink sidebarLink"><span><i class="bi bi-bar-chart px-3"></i> Analitycs</span></a>
                            <a href="" class="py-3 nav-link navLink sidebarLink"><span><i class="bi bi-chat px-3"></i> Messages</span><span class="badge bg-danger rounded-pill mx-4 justify-content-end">6</span></a>
