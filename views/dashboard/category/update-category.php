    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-10 mx-auto mt-5">
                <div class="row">
                    <div class="col-12">
                        <h1 class="fw-bold text-uppercase">Modifier une catégorie</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        ...
                        <form action="#" method="POST" class="shadow-lg p-5 rounded-4" novalidate enctype="multipart/form-data">
                            <div class="row">
                                <div class="mb-3 col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" value="<?= htmlspecialchars($category->label) ?>" pattern="<?= REGEX_CATEGORY ?>" aria-describedby="name" placeholder="Bons plans" minlength="5" maxlength="100" required>
                                </div>
                            </div>
                            <div class="py-3">
                                <button type="submit" class="btn btn-danger rounded-4 fw-bold text-uppercase">Modifier une catégorie</button>
