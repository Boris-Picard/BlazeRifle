<main>
                    ...
                    <div class="row">
                        ...
                        <?php if (!empty($articles[0])) { ?>
                            <div class="col-md-8 col-12 py-3">
                                <h2 class="h3 text-uppercase fw-bold">Toutes les news <span class="text-danger"><?= !empty($id_game) ? $articles[0]->game_name : '' ?></span></h2>
                            </div>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-12 col-md-9 py-5">
                                        <h3 class="articleTitle text-uppercase fw-bold">Pas de news en cours</h3>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
    ...
    <section>
                    ...
                    <div class="col-12">
                        <div class="row">
                            <div class="col-md-8 col-12 py-3 mt-5">
                                <h3 class="h3 text-uppercase fw-bold">Tous les guides <span class="text-danger"><?= !empty($id_game) ? $firstGuide->game_name : '' ?></span></h3>
                            </div>
                            <div class="col-md-4 col-12 d-flex btnTitle align-items-center justify-content-end mt-5">
                                <?php if (!empty($id_game)) { ?>
                                    <a href="/controllers/articles-list/articles-ctrl.php?id_game=<?= $firstGuide->id_game ?>&id_category=<?= $firstGuide->id_category ?>" class="btn btn-danger text-white btn-sm text-light rounded-4 buttonArticleSelectionGame fw-bold text-uppercase">
        ...
        <?php } else { ?>
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-9 py-5">
                        <h3 class="articleTitle text-uppercase fw-bold">Pas de guides en cours</h3>
                    </div>
                </div>
            </div>
        <?php } ?>
    ...
    <section>
            ...
            <div class="container py-5">
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="row">
                            <div class="col-md-8 col-12 py-3 mt-5">
                                <h3 class="h3 text-uppercase fw-bold">Toutes les vidéos <span class="text-danger"><?= !empty($id_game) ? $firstVideo->game_name : '' ?></span></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
        ...
        <?php } else { ?>
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-9 py-5">
                        <h3 class="articleTitle text-uppercase fw-bold">Pas de vidéos disponible</h3>
                    </div>
                </div>
            </div>
        <?php } ?>
        ...
        <div class="container py-5 mb-5">
            <div class="row g-3 mt-3">
                <div class="col-12 col-md-9">
                    <h3 class="articleTitle text-uppercase fw-bold">les événements à venir <span class="text-danger"><?= !empty($id_game) ? 'sur ' . $events[0]->game_name : '' ?></span></h3>
                </div>
    ...
    <?php } else { ?>
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-9">
                    <h3 class="articleTitle text-uppercase fw-bold">Pas d'événements en cours</h3>
                </div>
            </div>
        </div>
    <?php } ?>