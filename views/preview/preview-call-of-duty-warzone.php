                    ...
                    <div class="col-12">
                        <div class="row">
                            <div class="col-md-8 col-12 py-3">
                                <h2 class="h2 text-uppercase fw-bold">Les articles call of duty warzone</h2>
                            </div>
                            <div class="col-md-4 col-12 btnTitle d-flex align-items-center justify-content-end">
                                <a href="#" class="btn btn-danger btn-sm text-light rounded-4 buttonArticleSelectionGame fw-bold text-uppercase">
                                    Les articles call of duty warzone
                        ...
                        <div class="row">
                            <div class="col-12 d-flex flex-wrap justify-content-between colActus">
                                <div class="card bg-transparent text-white p-0 cardActu border-0 cardShadow ">
                                    <img src="/public/assets/img/MWII-SEASON-01-ROADMAP-004.jpg" class="card-img object-fit-cover rounded-4 h-100 w-100" alt="call of duty warzone" />
                                    <div class="card-img-overlay ">
                                        <span class="badge rounded-pill text-uppercase text-bg-danger p-2">call of duty warzone</span>
                                    ...
                                    <div class="card-body p-0 mt-1">
                                        ...
                                        <div class="card-text mb-3">
                                            <small class="text-muted">25 déc, 18:05
                                                ...
                                                <span class="badge rounded-pill text-uppercase mb-1 border text-dark fw-semibold">call of duty warzone</span>
                                            </small>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-12">
                        <div class="row">
                            <div class="col-md-8 col-12 py-3 mt-5">
                                <h2 class="h2 text-uppercase fw-bold">LES GUIDES call of duty warzone</h2>
                            </div>
                            <div class="col-md-4 col-12 d-flex btnTitle align-items-center justify-content-end mt-5">
                                <a href="#" class="btn btn-danger btn-sm text-light rounded-4 buttonArticleSelectionGame fw-bold text-uppercase">
                                    Les guides call of duty warzone
                                    <i class="bi bi-arrow-right mx-2" aria-hidden="true"></i>
                                </a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="card bg-dark text-white p-0 cardGuideLeft border-0 rounded-4 cardShadow">
                                    <img src="/public/assets/img/MWII-SEASON-01-ROADMAP-004.jpg" class="card-img object-fit-cover rounded-4 w-100 h-100" alt="Stony Beach" />
                                    <div class="card-img-overlay d-flex flex-column justify-content-end">
                                        <p class="p-0 m-0">
                                            <span class="badge rounded-pill text-uppercase text-bg-danger p-2 px-4 mb-2">call of duty warzone</span>
                                        </p>
                                        <div class="w-50">
                                        ...
                                        <div class="card-text mt-2">
                                            <small>il y a 47 minutes
                                                ...
                                                <span class="badge rounded-pill text-uppercase mb-1 border bg-transparent text-light fw-semibold">call of duty warzone</span>
                                            </small>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3 col-12 justify-content-between colGuideActus d-flex flex-column">
                                <div class="card cardGuideRight  bg-transparent border-0 overflow-hidden">
                                    <div class="row g-0 cardGuideRight">
                                        <div class="col-auto">
                                            <img src="/public/assets/img/MWII-SEASON-01-ROADMAP-004.jpg" alt="Trendy Pants and Shoes" class="imgGuideRight object-fit-cover rounded-4" />
                                        </div>
                                        <div class="col-md-8 p-0 ">
                                            <div class="card-body w-100 cardGuideRight p-0 mx-2 d-flex flex-column">
                                                <small class="card-text text-danger titlecardGuideRight text-uppercase fw-semibold m-0 p-0">Guide call of duty warzone</small>
                                                <div class="mt-1">
            ...
            <section>
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="row">
                            <div class="col-md-8 col-12 py-3 mt-5">
                                <h2 class="h2 text-uppercase fw-bold">Les dernières vidéos call of duty warzone</h2>
                            </div>
                            <div class="col-md-4 col-12 d-flex btnTitle align-items-center justify-content-end mt-5">
                                <a href="#" class="btn btn-danger btn-sm text-light rounded-4 buttonArticleSelectionGame fw-bold text-uppercase">
                                    Les vidéos call of duty warzone
                                    <i class="bi bi-arrow-right mx-2" aria-hidden="true"></i>
                                </a>
                            </div>
                        </div>
