                    ...
                    <div class="col-12">
                        <div class="row">
                            <div class="col-md-8 col-12 py-3">
                                <h2 class="h2 text-uppercase fw-bold">Les articles GTA 6</h2>
                            </div>
                                    ...
                                    <div class="card-body p-0 mt-1">
                                        ...
                                        <div class="card-text mb-3">
                                            <small class="text-muted">25 déc, 18:05
                                                ...
                                                <span class="badge rounded-pill text-uppercase mb-1 border text-dark fw-semibold">GTA 6</span>
                                            </small>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="card bg-dark text-white p-0 cardGuideLeft border-0 rounded-4 cardShadow">
                                    <img src="/public/assets/img/gta-6-news-visu.jpg" class="card-img object-fit-cover rounded-4 w-100 h-100" alt="Stony Beach" />
                                    <div class="card-img-overlay d-flex flex-column justify-content-end">
                                        <p class="p-0 m-0">
                                            <span class="badge rounded-pill text-uppercase text-bg-danger p-2 px-4 mb-2">GTA 6</span>
                                        </p>
                                        <div class="w-50">
